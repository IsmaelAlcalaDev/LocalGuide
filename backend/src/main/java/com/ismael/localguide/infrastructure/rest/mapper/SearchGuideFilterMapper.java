...
import com.ismael.localguide.domain.dto.SearchGuideFilterDTO;
import org.mapstruct.Mapper;
import org.mapstruct.Mapping;
import org.mapstruct.Mappings;

@Mapper(componentModel = "spring")
public interface SearchGuideFilterMapper {
    @Mappings({
    ...
    SearchGuideFilterDTO toDto(Guide guide, int totalReservations, Integer averageScore);
}
